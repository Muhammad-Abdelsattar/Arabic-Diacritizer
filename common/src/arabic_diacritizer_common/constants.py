...
class ArabicDiacritics(enum.Enum):
    ...
    def chars(cls) -> Set[str]:
        ...
        return {
            cls.SUKOON.value, cls.SHADDA.value, cls.DAMMA.value,
            cls.FATHA.value, cls.KASRA.value,
            cls.TANWEEN_DAMMA.value, cls.TANWEEN_FATHA.value, cls.TANWEEN_KASRA.value,
            cls.DAGGER_ALEF.value, cls.MADDA.value
        }
    ...
    def valid_combinations(cls) -> Set[str]:
        ...
        return {
            ...
            # Singles
            cls.SUKOON.value, cls.DAMMA.value, cls.FATHA.value, cls.KASRA.value,
            cls.TANWEEN_DAMMA.value, cls.TANWEEN_FATHA.value, cls.TANWEEN_KASRA.value,
            cls.DAGGER_ALEF.value, cls.MADDA.value,
            # Shadda combos
            cls.SHADDA_PLUS_DAMMA.value, cls.SHADDA_PLUS_FATHA.value,
            cls.SHADDA_PLUS_KASRA.value, cls.SHADDA_PLUS_TANWEEN_DAMMA.value,
            cls.SHADDA_PLUS_TANWEEN_FATHA.value, cls.SHADDA_PLUS_TANWEEN_KASRA.value,
        }
...
ARABIC_LETTERS_EXTENDED_BLOCK = [
    'ى',  # Alef Maqsura
    'ة',  # Taa Marbuta
    'پ', 'چ', 'ڤ', 'گ'  # Persian/Urdu additions
]
ALEF_VARIANTS = {'ا', 'أ', 'إ', 'آ'}

# Merge all letters
ARABIC_LETTERS = frozenset(ARABIC_LETTERS_BASE + ARABIC_LETTERS_EXTENDED_BLOCK + list(ALEF_VARIANTS))
